...
def add_files():
    ...
    root.quit()
    if os.path.isfile(filename) and filename.endswith(".mp3" or ".wav" or ".ogg"):
...
with dpg.theme(tag="songs"):
    with dpg.theme_component():
        ...
        dpg.add_theme_color(dpg.mvThemeCol_Button, (89, 89, 144))
        dpg.add_theme_color(dpg.mvThemeCol_ButtonHovered, (84, 84, 137))
        ...
        with dpg.child_window(width=200, tag="sidebar"):
            ...
            dpg.add_button(
                ...
                callback=lambda: webbrowser.open(
                    url="https://github.com/NotCookey/Rainy"
                ),
            )
            dpg.add_spacer(height=5)
            dpg.add_separator()
            dpg.add_spacer(height=5)
            dpg.add_button(label="Add Files", width=-1, height=28, callback=add_files)
